...
namespace Itop.TLPSP.DEVICE
{
	public partial class CtrlLayoutList : UserControl
	{
		...
		public bool RefreshData()
		{
			try
			{
				IList<LayoutList> list = UCDeviceBase.DataService.GetStrongList<LayoutList>();
        ...
        public bool RefreshData1()
        {
            ...
            {
                //IList<LayoutList> list = UCDeviceBase.DataService.GetStrongList<LayoutList>();
                IList<LayoutList> list = UCDeviceBase.DataService.GetList<LayoutList>("SelectLayoutListByTypes", type);
