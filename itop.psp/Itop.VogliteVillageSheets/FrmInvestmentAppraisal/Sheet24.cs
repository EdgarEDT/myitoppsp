...
/*
 *  ClassName：Sheet24
 *  Action：附表24 2020年铜陵县35kV主变“N-1”校验结果 的数据写入
...
namespace Itop.VogliteVillageSheets.FrmInvestmentAppraisal
{
    class Sheet24
    {
        ...
        public void SetSheet_24Title(Itop.Client.Base.FormBase FB, FarPoint.Win.Spread.SheetView obj, string Title)
        {
            int Temp = 0;
            int IntColCount = 12;
            ReturnBDZ(FB);
        ...
        {
            string sql = " AreaID='" + FB.ProjectUID + "' and L1=35 and s2<=2020 ";
