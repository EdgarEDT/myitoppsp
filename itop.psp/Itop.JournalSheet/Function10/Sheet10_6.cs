...
namespace Itop.JournalSheet.Function10
{
    class Sheet10_6
    {
        ...
        public void SetSheet10_6Title( FarPoint.Win.Spread.SheetView obj, string Title)
        {
            AreaType[0] = "市辖供电区";
            AreaType[1] = "县级供电区";
        ...
        private int SelectProg()
        {
            ...
            temp = Services.BaseService.GetList("SelectTZGSProgType", "");
            return temp.Count;
        }
        /// <summary>
        /// 返回工程的金额
