...
{
	public partial class CtrlPowerEachTotalList : UserControl
	{
		#region 构造方法
		public CtrlPowerEachTotalList()
		{
			InitializeComponent();
		}
		#endregion
		...
		/// </summary>
		public IList<PowerEachTotalList> ObjectList
		{
			get { return this.gridControl.DataSource as IList<PowerEachTotalList>; }
		}

		/// <summary>
		/// 获取焦点对象，即FocusedRow
		/// </summary>
		public PowerEachTotalList FocusedObject
		{
			get { return this.gridView.GetRow(this.gridView.FocusedRowHandle) as PowerEachTotalList; }
		}
		#endregion
		...
		public bool RefreshData()
		{
			try
			{
				IList<PowerEachTotalList> list = Services.BaseService.GetStrongList<PowerEachTotalList>();
