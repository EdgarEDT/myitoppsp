...
{
	public partial class CtrlLayoutAHTL : UserControl
	{
		#region 构造方法
        public CtrlLayoutAHTL()
		{
			InitializeComponent();
		...
		/// </summary>
		public IList<LayoutANTL> ObjectList
		{
			get { return this.gridControl.DataSource as IList<LayoutANTL>; }
		}

		/// <summary>
		/// 获取焦点对象，即FocusedRow
		/// </summary>
		public LayoutANTL FocusedObject
		{
			get { return this.gridView.GetRow(this.gridView.FocusedRowHandle) as LayoutANTL; }
		}
		#endregion
		...
		private void gridView_DoubleClick(object sender, EventArgs e)
		{
            ...
            if (FocusedObject != null)
            {
                ...
                FrmGHBZTLContents dlg = new FrmGHBZTLContents();
                FrmGHBZTLContents.ParentForm = dlg;
                dlg.RightObject = vp;
		...
		public bool RefreshData()
		{
			try
			{
                IList<LayoutANTL> list = Services.BaseService.GetList<LayoutANTL>("SelectLayoutANTLListByCreater",Itop.Client.MIS.ProgUID);
		...
		public void AddObject()
		{
			...
			//执行添加操作
			using (FrmLayoutDialogANTL dlg = new FrmLayoutDialogANTL())
			{
		...
		public void UpdateObject()
		{
			...
			//创建对象的一个副本
			LayoutANTL objCopy = new LayoutANTL();
			DataConverter.CopyTo<LayoutANTL>(obj, objCopy);
			...
			//用副本更新焦点对象
			DataConverter.CopyTo<LayoutANTL>(objCopy, obj);
			//刷新表格
			gridControl.RefreshDataSource();
		}
		...
		public void DeleteObject()
		{
            ...
            IList<LayoutContentANTL> Li=  Services.BaseService.GetList<LayoutContentANTL>("SelectLayoutContentANTLByLayoutID",obj.UID);
			...
			try
			{
				Services.BaseService.Delete<LayoutANTL>(obj);
