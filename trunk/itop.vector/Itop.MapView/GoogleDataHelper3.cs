...
namespace Itop.MapView
{
    ...
    public class GoogleDataHelper3 : IDataHelper
    {
        static IObjectContainer db;
        System.Net.WebClient webClient = new System.Net.WebClient();
        string strImgsvrUrl = "";
        string storeImgPath = "MapData3.map";
        ...
        public GoogleDataHelper3(string database)
            : this(database, "m3_") {
        }
        public GoogleDataHelper3(string database, string maptype) {
            mapType = maptype;
