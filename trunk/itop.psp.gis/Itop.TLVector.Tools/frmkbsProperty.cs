...
{
    public partial class frmkbsProperty : FormBase
    {
        ...
        public void InitData(string useid,string svguid,string layID)
        {
            ...
            try
            {
                ...
                col_year.DataBindings.Add("Text", sub, "col2");
                col_hw.DataBindings.Add("Text", sub, "col3");
                col_zg.DataBindings.Add("Text", sub, "col4");
                col_cg.DataBindings.Add("Text", sub, "col5");
                col_zt.DataBindings.Add("Text", sub, "col1");
                col_zb.DataBindings.Add("Text", sub, "col6");
                remark.DataBindings.Add("Text", sub, "col7");
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            sub.col2 = col_year.Text;
            sub.col3 = col_hw.Text;
            sub.col4 = col_zg.Text;
            sub.col5 = col_cg.Text;
            sub.col6 = col_zb.Text;
            sub.col7 = remark.Text;
