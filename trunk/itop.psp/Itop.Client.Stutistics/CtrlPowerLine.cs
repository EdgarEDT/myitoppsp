...
{
	public partial class CtrlPowerLine : UserControl
	{
		#region 构造方法
		public CtrlPowerLine()
		{
			InitializeComponent();
		}
		#endregion
		...
		/// </summary>
		public IList<PowerLine> ObjectList
		{
			get { return this.gridControl.DataSource as IList<PowerLine>; }
		}

		/// <summary>
		/// 获取焦点对象，即FocusedRow
		/// </summary>
		public PowerLine FocusedObject
		{
			get { return this.gridView.GetRow(this.gridView.FocusedRowHandle) as PowerLine; }
		}
		#endregion
		...
		public bool RefreshData()
		{
			try
			{
				IList<PowerLine> list = Services.BaseService.GetStrongList<PowerLine>();
