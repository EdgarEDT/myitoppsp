...
{
	public partial class FrmPowerEachListDialog2 : FormBase
	{
		...
		#region 构造方法
        public FrmPowerEachListDialog2()
		{
			InitializeComponent();
		}
		#endregion
		...
		private void btnOK_Click(object sender, EventArgs e)
		{
            ...
            if (Common.Services.BaseService.GetObject("SelectPowerEachListListByTypesAndListName", _obj) != null)
            {
