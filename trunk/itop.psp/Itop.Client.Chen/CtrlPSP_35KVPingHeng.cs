...
{
	public partial class CtrlPSP_35KVPingHeng : UserControl
	{
		#region 构造方法
		public CtrlPSP_35KVPingHeng()
		{
			InitializeComponent();
		}
		#endregion
		...
		/// </summary>
		public IList<PSP_35KVPingHeng> ObjectList
		{
			get { return this.gridControl.DataSource as IList<PSP_35KVPingHeng>; }
		}

		/// <summary>
		/// 获取焦点对象，即FocusedRow
		/// </summary>
		public PSP_35KVPingHeng FocusedObject
		{
			get { return this.gridView.GetRow(this.gridView.FocusedRowHandle) as PSP_35KVPingHeng; }
		}
		#endregion
		...
		public bool RefreshData()
		{
			try
			{
				IList<PSP_35KVPingHeng> list = Services.BaseService.GetStrongList<PSP_35KVPingHeng>();
