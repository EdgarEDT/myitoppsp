...
{
    public delegate void DownCompleteEventHandler(ClassImage mapclass);
    public class GoogleDataHelper : IDataHelper
    {
        static IObjectContainer db;
        System.Net.WebClient webClient = new System.Net.WebClient();
        string strImgsvrUrl = "";
        string storeImgPath = "MapData.map";
        ...
        public GoogleDataHelper()
            : this("") {
        }
        public GoogleDataHelper(string database)
            : this(database, "m1_") {
        }
        public GoogleDataHelper(string database, string maptype) {
            mapType = maptype;
